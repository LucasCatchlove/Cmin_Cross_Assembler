...
public class TestInstruction {
    ...
    public static void main(String[] args) {
        ...
        Instruction inst1 = new Instruction(new Mnemonic("teq", 0x1A), "");
        Instruction inst2 = new Instruction(new Mnemonic("add", 0x0C), "");
        Instruction inst3 = new Instruction(new Mnemonic("sub", 0x0D), "");

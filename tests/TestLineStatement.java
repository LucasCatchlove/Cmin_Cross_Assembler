...
public class TestLineStatement {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Test components.LineStatement getLabel");
        System.out.println("");
        System.out.println(lineStatement.getLabel());

        System.out.println("Test components.LineStatement getInstruction");
        System.out.println("components.Mnemonic: (Name: mul, Opcode: 15), Operand: ");
        System.out.println(lineStatement.getInstruction());

        System.out.println("Test components.LineStatement getComment");
        System.out.println("");
